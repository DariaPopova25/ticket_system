...
class TestManagerUpdateTicket:
    ...
    def test_manager_can_remove_assignee_in_new_status(
        self,
        user_manager,
        ticket_factory,
    ):
    ...
    def test_raises_error_if_actor_is_not_manager(
        self,
        request,
        ticket_factory,
        user_fixture,
    ...
    def test_raises_error_if_manager_updates_closed_ticket(
        self,
        status,
        ticket_factory,
        user_manager,
    ...
    def test_raises_error_if_manager_removes_assignee_outside_new(
        self,
        status,
        ticket_factory,
        user_manager,
    ...
    def test_raises_error_if_manager_assigns_non_developer(
        self,
        user_manager,
        user_client,
        ticket_factory,
...
class TestDeveloperUpdateTicket:
    ...
    def test_developer_can_update_assigned_ticket(
        self,
        status,
        user_developer,
        ticket_factory,
    ...
    def test_raises_error_if_actor_is_not_developer(
        self,
        request,
        ticket_factory,
        user_fixture,
    ...
    def test_raises_error_if_developer_updates_ticket_assigned_to_another_developer(
        self,
        ticket_factory,
        user_developer,
    ):
    ...
    @pytest.mark.parametrize("status", DEVELOPER_ALLOWED_STATUSES)
    def test_raises_error_if_developer_updates_ticket_in_new_status(
        self,
        status,
        ticket_factory,
        user_developer,
    ...
    def test_raises_error_if_developer_sets_disallowed_status(
        self,
        status,
        ticket_factory,
        user_developer,
    ...
    @pytest.mark.parametrize("status", CLOSED_STATUSES)
    def test_raises_error_if_developer_updates_closed_ticket(
        self,
        status,
        user_developer,
        ticket_factory,
...
class TestCreateComment:
    ...
    def test_developer_can_comment_on_assigned_ticket(
        self,
        user_developer,
        ticket_factory,
    ):
    ...
    def test_raises_error_if_client_comments_on_another_users_ticket(
        self,
        user_client,
        ticket_factory,
    ):
